(() => {
  ...
  function logoHTML(symbol, sizeClass=''){
    ...
    if(!src)return `<span class="stock-logo-fallback ${sizeClass}">${letter}</span>`;
    return `<span class="stock-logo-wrap ${sizeClass}"><img class="stock-logo" src="${src}" alt="" referrerpolicy="no-referrer"><span class="stock-logo-fallback">${letter}</span></span>`;
  }
